...
Anyway, look: I get that the reason for a UI change can be "because it was time for a change". My hope is that the Liquid Glass UI will be refined over time and that most or all of these issues will addressed. I know a lot of well-meaning people worked hard on this stuff. I also don't think this design is unusably bad, and it's definitely not unfixable… but I do think there's [a long way to go](https://bsky.app/search?q=%22liquid+glass%22). [^4]
